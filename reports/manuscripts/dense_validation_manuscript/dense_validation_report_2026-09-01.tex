...
Before interpreting scalar validation metrics, it is useful to see examples of
...
\item \textbf{Residual ridge layer:} residual model using selected model-agnostic covariate
  covariates.
\end{enumerate}
