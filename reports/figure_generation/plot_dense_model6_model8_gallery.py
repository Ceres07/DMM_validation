...
DEFAULT_FIG = REPO / "reports" / "model6_vs_model8_dense" / "figures" / "dense_coarse_model6_model8_gallery.png"
...
def main() -> int:
    args = parse_args()
    triplets = discover_date_triplets(args.model6_dir, args.model8_dir)
